Giới thiệu
Dự án sử dụng Python và Pandas để xử lý, phân tích và biến đổi dữ liệu xét tuyển đại học từ file dulieuxettuyendaihoc.csv. Mục tiêu là làm sạch dữ liệu, tạo biến mới và xác định kết quả xét tuyển.
